...
export class LevelMenagementService {
  httpOptions = {
  ...
  getDataPage(command: PageContext<MilitaryFormationPageFilter>):Observable<CollectionViewModel<LevelManagement[]>>{
    return this.client.post<UsersCollectionViewModel<LevelManagement[]>>(
      `${environment.api}/api/v1/level-management/page`,
